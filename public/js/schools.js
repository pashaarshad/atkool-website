...
function setupEventListeners() {
    ...
    if (toggleSchoolPassword && schoolPassword) {
        toggleSchoolPassword.addEventListener('click', function () {
            if (schoolPassword.type === 'password') {
                schoolPassword.type = 'text';
                toggleSchoolPassword.innerHTML = eyeClosedSvg;
            } else {
                schoolPassword.type = 'password';
